...
const cores = {
  brazil: [
    ...
    ["Guimaraes Claudinho", 29, "CAM", ["LW"], "Zenit", 35, 78, "Izq.", "1.71 m"],
    ["Pulgar Erick", 30, "CDM", ["CM"], "Fiorentina", 36, 76, "Der.", "1.82 m"],
    // Delanteros
  ...
  argentina: [
    ...
    ["Alejandro Castillo", 27, "LB", ["LWB"], "San Lorenzo", 39, 73, "Izq.", "1.75 m"],
  ...
  france: [
    ...
    ["Aaron Wan-Bissaka", 28, "RB", ["CB"], "West Ham United", 27, 79, "Der.", "1.83 m"],
    ...
    ["Axel Witsel", 36, "CDM", ["CM"], "Atletico Madrid", 42, 78, "Der.", "1.82 m"],
    ...
    ["Juan Bernat", 32, "LB", ["LWB"], "Benfica", 58, 78, "Izq.", "1.71 m"],
  ...
  england: [
    ...
    ["Tyler Adams", 26, "CDM", ["CM"], "Bournemouth", 42, 78, "Der.", "1.77 m"],
    // Delanteros
    ...
    ["Nkah Chalobah", 26, "CM", ["CDM"], "Crystal Palace", 52, 77, "Der.", "1.87 m"],
  ...
  spain: [
    ...
    ["Juan Foyth", 28, "RB", ["CB"], "Villarreal", 26, 80, "Der.", "1.83 m"],
    ...
    ["Ivan Rakitic", 37, "CM", ["CDM"], "Hajduk Split", 39, 77, "Der.", "1.84 m"],
    ...
    ["Ante Budimir", 34, "ST", ["CF"], "Osasuna", 48, 78, "Der.", "1.88 m"],
